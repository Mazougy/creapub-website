  ...
  return (
    <footer className="border-t border-white/10 bg-black py-10">
      <div className="container-padded flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        <div>
          <a href="#top" className="font-display text-xl font-semibold text-white" aria-label="Back to Creapub home">
            {company.name}
          </a>
        ...
        <p className="text-sm text-white/42">
          © {new Date().getFullYear()} Creapub. Premium visual communication.
        </p>
      </div>
    </footer>
  );
